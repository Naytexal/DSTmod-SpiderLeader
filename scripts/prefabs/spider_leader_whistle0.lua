...
local assets =
{
    Asset("ANIM", "anim/spider_leader_whistle0.zip"),
    Asset("ATLAS", "images/spider_leader_whistle0.xml"),
    Asset("IMAGE", "images/spider_leader_whistle0.tex"),	
...
local function fn()
    ...
    inst.AnimState:SetBank("spider_leader_whistle0")
    inst.AnimState:SetBuild("spider_leader_whistle0")
    inst.AnimState:PlayAnimation("idle", true)
    MakeInventoryPhysics(inst)

    MakeInventoryFloatable(inst, "small", 0.15, 0.9)

	inst:AddTag("spider_leader_whistle0")
    ...
    inst.components.inventoryitem.imagename = "spider_leader_whistle0"
    inst.components.inventoryitem.atlasname = "images/spider_leader_whistle0.xml"
...
return Prefab("spider_leader_whistle0", fn, assets)